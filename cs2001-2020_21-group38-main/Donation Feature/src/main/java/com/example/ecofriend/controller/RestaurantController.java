...
public class RestaurantController {
	...
	public ResponseEntity<?> addRestaurant(@RequestBody Restaurant res) throws ResourceNotFoundException {
		
		if(res == null || res.getName().isEmpty()) {
	        throw new ResourceNotFoundException( "Make sure you entered all the required details");
