...
public class DonationController {
	...
	public ResponseEntity<?> getDonationsByRestaurant(@PathVariable(value = "restaurantId") Long restaurantId) throws ResourceNotFoundException {
		List<Donation> existedId=  donationRepository.findRestaurantById(restaurantId);
	...
	public Donation addDonationByRestaurantId(@PathVariable(value = "restaurantId") Long restaurantId,
